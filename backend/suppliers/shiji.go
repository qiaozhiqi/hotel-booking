...
var ShijiSubSuppliers = []ShijiSubSupplierConfig{
	...
	},
	{
		Code:         "shiji_qiuguo",
		Name:         "秋果集团（石基畅联）",
		Description:  "秋果集团是中国知名的中端酒店集团，旗下拥有秋果酒店等多个品牌。通过石基畅联渠道接入，采用推送模式同步酒店数据。",
		APIURL:       "/api/shiji/qiuguo/push",
		HotelTypes:   []string{"秋果酒店", "秋果S酒店", "秋果Q酒店"},
		Cities:       []string{"北京", "上海", "广州", "深圳", "杭州", "成都", "武汉", "西安", "南京", "苏州", "天津", "重庆"},
		AddressSuffixes: []string{"中关村店", "国贸店", "天河店", "南山店", "西湖店", "春熙路店", "光谷店", "大雁塔店", "新街口店", "观前街店", "和平路店", "解放碑店"},
		MinPriceBase: 280,
		MaxPriceBase: 250,
		RatingBase:   4.3,
		RatingRange:  0.5,
		...
		HotelCount:   12,
		ImageThemes: []string{
			"qiuguo hotel modern minimalist lobby",
			"qiuguo boutique hotel entrance",
			"qiuguo business hotel exterior",
			"qiuguo hotel comfortable bedroom",
			"qiuguo hotel lobby with green plants",
			"qiuguo hotel modern room design",
			"qiuguo hotel reception area",
			"qiuguo hotel corridor lighting",
			"qiuguo hotel breakfast area",
			"qiuguo hotel business center",
			"qiuguo hotel fitness room",
			"qiuguo hotel rooftop lounge",
		},
		RoomTypeConfigs: []ShijiRoomTypeStaticConfig{
			{"精选大床房", "秋果精选大床房，配备高品质床品和现代化设施。简约设计风格，舒适温馨，是商务出行的理想选择。", 2, 26, "大床", "免费WiFi, 中央空调, 智能电视, 24小时热水, 吹风机, 电热水壶, 免费矿泉水", 280, 1.0},
			{"精选双床房", "秋果精选双床房，两张舒适单人床，配备高品质床品。适合双人入住，干净整洁，提供优质睡眠体验。", 2, 28, "双床", "免费WiFi, 中央空调, 智能电视, 24小时热水, 吹风机, 电热水壶, 免费矿泉水", 280, 1.05},
			{"高级大床房", "秋果高级大床房，空间更宽敞，配备高品质家具和床品。享有城市美景，提供更舒适的住宿体验。", 2, 32, "大床", "免费WiFi, 中央空调, 智能电视, 24小时热水, 吹风机, 电热水壶, 免费矿泉水, 迷你吧", 280, 1.3},
			{"商务套房", "秋果商务套房，独立客厅与卧室，配备宽大办公桌和高速网络。专为商务精英打造，享受尊贵住宿体验。", 2, 48, "大床", "免费WiFi, 中央空调, 智能电视, 24小时热水, 吹风机, 电热水壶, 免费矿泉水, 迷你吧, 保险箱", 280, 2.0},
			{"家庭亲子房", "秋果家庭亲子房，配备大床和儿童床，适合家庭出行。空间宽敞，设施齐全，提供温馨的家庭住宿体验。", 4, 45, "大床+儿童床", "免费WiFi, 中央空调, 智能电视, 24小时热水, 吹风机, 电热水壶, 免费矿泉水, 儿童用品", 280, 1.8},
		},
	},
}
